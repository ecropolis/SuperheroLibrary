...
export interface Element {
  ...
  file: string;
  /**
   * Set only when `file` is a synced copy of a component owned by another repo. The gallery then
   * says to sync it rather than copy it, and the file must never be edited here.
   */
